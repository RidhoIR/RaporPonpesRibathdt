...
@section('title', 'Rapor Santri' . config('app.name'))
@section('content')
    <div class="">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="text-uppercase mb-0">Data Rapor</h2>
            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addModal">+ Tambah Rapor</button>
        </div>
        <hr />
        <div class="card">
            <div class="card-body">
